...
public class ViewRoomsPage extends JPanel implements NavUpdate {
	...
	/**
	 * This is the default constructor of ViewRoomsPage, it simply
	...
	public ViewRoomsPage() {
		...
		back.addActionListener(e -> UI.navTo(UI.Routes.MAIN_PAGE));
		this.add(back, c);
	...
	/**
	 * navUpdate in ViewRoomsPage collects all of the current rooms that are in the hotel
	 * system and populates the table
	 */
	@Override
